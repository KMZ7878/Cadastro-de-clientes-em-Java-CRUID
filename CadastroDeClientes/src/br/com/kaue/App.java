...
import br.com.kaue.ClienteMapDAO;
import br.com.kaue.IClienteDAO;
...
public class App {
    ...
    private static void consultar(String dados){
        ...
        if (cliente != null){
            ...
            JOptionPane.showMessageDialog(null, "Cliente não encontrado", "CADASTROS", JOptionPane.INFORMATION_MESSAGE);
        }
    }
